...
namespace TarotNow.Infrastructure.Migrations
{
    ...
    [Migration("20260426075733_AddOutboxInlineIdempotencyAndDisputeReasonAndUserSearchIndex")]
    partial class AddOutboxInlineIdempotencyAndDisputeReasonAndUserSearchIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TarotNow.Domain.Entities.AiRequest", b =>
                {
                    ...
                    b.Property<Guid>("ReadingSessionRef")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TarotNow.Domain.Entities.FreeDrawCredit", b =>
                {
                    ...
                    b.Property<int>("SpreadCardCount")
                        .HasColumnType("integer")
                        .HasColumnName("spread_card_count");
                    ...
                    b.HasIndex("UserId", "SpreadCardCount")
                        .IsUnique()
                        .HasDatabaseName("ix_free_draw_credits_user_id_spread_card_count");

                    b.ToTable("free_draw_credits", null, t =>
                        {
                            t.HasCheckConstraint("ck_free_draw_credits_available_count", "\"available_count\" >= 0");

                            t.HasCheckConstraint("ck_free_draw_credits_spread_card_count_valid", "\"spread_card_count\" IN (3,5,10)");
                        });
                });
            ...
            modelBuilder.Entity("TarotNow.Domain.Entities.WithdrawalRequest", b =>
                {
                    ...
                    b.Property<DateOnly>("BusinessWeekStartUtc")
                        .HasColumnType("date")
                        .HasColumnName("business_week_start_utc");
