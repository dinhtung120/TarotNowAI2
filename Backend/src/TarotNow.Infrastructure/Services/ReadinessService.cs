...
{
    private static readonly string[] RequiredPostgreSqlTables = ["users", "user_subscriptions", "gacha_pools", "auth_sessions", "refresh_tokens"];
        ...
        try
        {
            ...
            var query = """
                        ...
                        WHERE table_schema = 'public'
                          AND table_name IN ('users', 'user_subscriptions', 'gacha_pools', 'auth_sessions', 'refresh_tokens')
                        """;
