...
public partial class WalletRepository
{
    ...
    private static WalletTransaction CreateWalletLedgerEntry(WalletLedgerEntryRequest request)
    {
        return WalletTransaction.Create(new WalletTransactionCreateRequest
        {
            ...
            AvailableBalanceBefore = request.AvailableBalanceBefore,
            AvailableBalanceAfter = request.AvailableBalanceAfter,
            FrozenBalanceBefore = request.FrozenBalanceBefore,
            FrozenBalanceAfter = request.FrozenBalanceAfter,
