...
public sealed class StreamReadingCommandHandlerRequestedDomainEventHandler
    : IdempotentDomainEventNotificationHandler<StreamReadingCommandHandlerRequestedDomainEvent>
{
    private readonly ICommandExecutionExecutor<StreamReadingCommand, StreamReadingResult> _executor;

    public StreamReadingCommandHandlerRequestedDomainEventHandler(
        ICommandExecutionExecutor<StreamReadingCommand, StreamReadingResult> executor,
