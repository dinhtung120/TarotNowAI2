...
public sealed class RevokeTokenCommandHandlerRequestedDomainEventHandler
    : IdempotentDomainEventNotificationHandler<RevokeTokenCommandHandlerRequestedDomainEvent>
{
    private readonly ICommandExecutionExecutor<RevokeTokenCommand, bool> _executor;

    public RevokeTokenCommandHandlerRequestedDomainEventHandler(
        ICommandExecutionExecutor<RevokeTokenCommand, bool> executor,
