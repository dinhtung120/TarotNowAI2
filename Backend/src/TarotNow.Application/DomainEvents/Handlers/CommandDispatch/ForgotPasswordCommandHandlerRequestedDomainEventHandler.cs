...
public sealed class ForgotPasswordCommandHandlerRequestedDomainEventHandler
    : IdempotentDomainEventNotificationHandler<ForgotPasswordCommandHandlerRequestedDomainEvent>
{
    private readonly ICommandExecutionExecutor<ForgotPasswordCommand, bool> _executor;

    public ForgotPasswordCommandHandlerRequestedDomainEventHandler(
        ICommandExecutionExecutor<ForgotPasswordCommand, bool> executor,
