...
public sealed class DeletePostCommandHandlerRequestedDomainEventHandler
    : IdempotentDomainEventNotificationHandler<DeletePostCommandHandlerRequestedDomainEvent>
{
    private readonly ICommandExecutionExecutor<DeletePostCommand, bool> _executor;

    public DeletePostCommandHandlerRequestedDomainEventHandler(
        ICommandExecutionExecutor<DeletePostCommand, bool> executor,
