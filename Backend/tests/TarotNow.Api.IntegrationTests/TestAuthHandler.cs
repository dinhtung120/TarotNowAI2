...
/// <summary>
/// Handler hỗ trợ Integration Test đi qua được tấm khiên [Authorize] 
/// mà không cần phải gọi API Login sinh JWT token thực tế.
/// </summary>
public class TestAuthHandler : AuthenticationHandler<AuthenticationSchemeOptions>
{
    ...
    protected override Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        // Tạo Test Principal với UserId động để tránh conflict State Machine giữa các Test Cases
        var claims = new[] 
        { 
