...
public class MfaVerifyCommandHandlerRequestedDomainEventHandlerTests
{
    ...
    private readonly MfaVerifyCommandHandlerRequestedDomainEventHandler _handler;

    /// <summary>
    /// Khởi tạo fixture cho MfaVerifyCommandHandlerRequestedDomainEventHandler.
    /// Luồng dùng mock services để cô lập logic verify MFA khỏi crypto thật.
    /// </summary>
    public MfaVerifyCommandHandlerRequestedDomainEventHandlerTests()
    {
        _mockUserRepo = new Mock<IUserRepository>();
        _mockMfaService = new Mock<IMfaService>();
        _handler = new MfaVerifyCommandHandlerRequestedDomainEventHandler(
