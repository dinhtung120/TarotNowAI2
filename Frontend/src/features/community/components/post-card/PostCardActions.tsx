 ...
 return (
  <>
   <div className="flex items-center gap-6">
    ...
    <button type="button" onClick={onToggleComments} className={`flex items-center gap-1.5 transition-colors ${showComments ? "text-[#ff00ff]" : "text-gray-400 hover:text-gray-200"}`}>
