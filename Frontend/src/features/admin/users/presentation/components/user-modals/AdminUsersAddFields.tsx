 ...
 return (
  <div className={cn('p-8 space-y-5')}>
   <div className={cn('tn-grid-cols-1-2-md gap-5')}>
    <label className={cn('space-y-2 block')}><span className={cn('tn-text-10 font-black uppercase tracking-widest tn-text-secondary block text-left')}>{t('users.add_user.email_label')}</span><input type="email" value={addForm.email} onChange={(event) => update('email', event.target.value)} placeholder={t('users.add_user.email_placeholder')} className={cn(FIELD_CLASS)} /></label>
    <label className={cn('space-y-2 block')}><span className={cn('tn-text-10 font-black uppercase tracking-widest tn-text-secondary block text-left')}>{t('users.add_user.username_label')}</span><input type="text" value={addForm.username} onChange={(event) => update('username', event.target.value)} placeholder={t('users.add_user.username_placeholder')} className={cn(FIELD_CLASS)} /></label>
   </div>
   <div className={cn('tn-grid-cols-1-2-md gap-5')}>
    <label className={cn('space-y-2 block')}><span className={cn('tn-text-10 font-black uppercase tracking-widest tn-text-secondary block text-left')}>{t('users.add_user.display_name_label')}</span><input type="text" value={addForm.displayName} onChange={(event) => update('displayName', event.target.value)} placeholder={t('users.add_user.display_name_placeholder')} className={cn(FIELD_CLASS)} /></label>
    <label className={cn('space-y-2 block')}><span className={cn('tn-text-10 font-black uppercase tracking-widest tn-text-secondary block text-left')}>{t('users.add_user.password_label')}</span><input type="password" value={addForm.password} onChange={(event) => update('password', event.target.value)} placeholder={t('users.add_user.password_placeholder')} className={cn(FIELD_CLASS)} /></label>
   </div>
