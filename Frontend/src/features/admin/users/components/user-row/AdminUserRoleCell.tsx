...
export function AdminUserRoleCell({ t, user }: AdminUserRoleCellProps) {
 return (
  <td className={cn('px-8 py-5')}>
   <div className={cn('inline-flex items-center gap-1.5 px-3 py-1 rounded-full tn-text-9 font-black uppercase tracking-widest border shadow-inner', roleClassName(user.role))}>
