...
export function AdminUserStatusCell({ t, user }: AdminUserStatusCellProps) {
 return (
  <td className={cn('px-8 py-5 text-center')}>
   <div className={cn('inline-flex items-center justify-center gap-2 tn-text-9 font-black uppercase tracking-widest', user.isLocked ? 'tn-text-danger' : 'tn-text-success')}>
