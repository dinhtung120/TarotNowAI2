 ...
 return (
  <div className={cn('flex flex-col md:flex-row md:items-end justify-between gap-6')}>
   <SectionHeader
    ...
    tagIcon={<TrendingUp className={cn('w-3 h-3 text-[var(--success)]')} />}
   ...
   <div className={cn('flex items-center gap-4 shrink-0')}>
    <div className={cn('px-6 py-3 rounded-2xl tn-panel')}>
     <div className={cn('text-[8px] font-black uppercase tracking-widest tn-text-muted text-left')}>
      {t('dashboard.health.title')}
     </div>
     <div className={cn('flex items-center gap-2 text-xs font-bold text-[var(--success)]')}>
