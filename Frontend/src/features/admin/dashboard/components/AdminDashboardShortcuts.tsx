...
import { getAdminShortcutItems } from "@/features/admin/dashboard/components/adminDashboardShortcuts.items";
import type { AdminRoute } from "@/features/admin/dashboard/components/types";
