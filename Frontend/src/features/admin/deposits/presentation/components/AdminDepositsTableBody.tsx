 ...
 return (
  <tbody className={cn("divide-y divide-white/5")}>
   <TableStates
    ...
    emptyIcon={<div className={cn("w-16 h-16 rounded-full tn-panel-soft flex items-center justify-center")}><CreditCard className={cn("w-8 h-8 text-[var(--text-tertiary)] opacity-50")} /></div>}
   />
