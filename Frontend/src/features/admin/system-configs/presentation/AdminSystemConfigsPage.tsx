...
import SystemConfigsEditorPanel from '@/features/admin/system-configs/presentation/SystemConfigsEditorPanel';
import SystemConfigsListPanel from '@/features/admin/system-configs/presentation/SystemConfigsListPanel';
