...
interface ReaderDirectoryLoadingStateProps {
  label: string;
}

export default function ReaderDirectoryLoadingState({
  label,
}: ReaderDirectoryLoadingStateProps) {
  return (
    <div
      className={cn(
        "flex h-[40vh] flex-col items-center justify-center space-y-6",
      )}
    >
