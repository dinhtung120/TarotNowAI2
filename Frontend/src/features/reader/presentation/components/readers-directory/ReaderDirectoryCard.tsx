...
import ReaderDirectoryCardProfile from '@/features/reader/presentation/components/readers-directory/card/ReaderDirectoryCardProfile';
import ReaderDirectoryCardSocialLinks from '@/features/reader/presentation/components/readers-directory/card/ReaderDirectoryCardSocialLinks';
import ReaderDirectoryCardSpecialties from '@/features/reader/presentation/components/readers-directory/card/ReaderDirectoryCardSpecialties';
import ReaderDirectoryCardStats from '@/features/reader/presentation/components/readers-directory/card/ReaderDirectoryCardStats';
