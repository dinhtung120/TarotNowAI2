...
export function ReaderProfileBackButton({
 ...
 return (
  <button onClick={onBack} className={cn('flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-[var(--text-secondary)] hover:tn-text-primary transition-colors group')}>
