...
import { useChatInboxPage } from '@/features/chat/inbox/useChatInboxPage';
import { cn } from '@/lib/utils';
import { ConversationListItem } from '@/features/chat/inbox/components/conversation-sidebar/ConversationListItem';
import { ConversationSidebarTabs } from '@/features/chat/inbox/components/conversation-sidebar/ConversationSidebarTabs';
  ...
  return (
    <div className={cn('flex flex-col h-full overflow-hidden gap-3 tn-p-3-4-md')}>
      ...
      <div className={cn('flex-1 overflow-y-auto space-y-2 pr-1 custom-scrollbar')}>
        ...
        {!effectivelyLoading && conversations.length === 0 ? (
        ...
        {!effectivelyLoading && conversations.map((conversation) => (
