    ...
    <div className={cn("overflow-x-auto")}>
      <table className={cn("w-full text-left")}>
        ...
        <tbody className={cn("divide-y divide-slate-800/40 text-slate-300")}>
          {titles.map((title) => (
            <tr key={title.code} className={cn("group transition-colors")}>
              ...
              <td className={cn("px-6 py-4")}>
                <span
                  className={cn("px-2 py-0.5 rounded tn-text-10 font-black uppercase", 
              ...
              <td className={cn("px-6 py-4 text-right flex justify-end gap-2")}>
                <button type="button" onClick={() => onEdit(title.code)} className={cn("p-2 rounded-lg text-slate-400 transition-colors")}>
                  <Edit className={cn("w-4 h-4")} />
                </button>
                <button type="button" onClick={() => onDelete(title.code)} className={cn("p-2 rounded-lg text-slate-400 transition-colors")}>
