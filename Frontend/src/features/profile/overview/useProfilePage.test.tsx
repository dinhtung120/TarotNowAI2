...
import { updateProfileAction } from '@/features/profile/overview/actions/actions';
import { uploadProfileAvatar } from '@/features/profile/overview/uploadProfileAvatar';
...
vi.mock('@/features/profile/overview/actions/actions', () => ({
 getPayoutBanksAction: vi.fn(),
 updateProfileAction: vi.fn(),
}));

vi.mock('@/features/profile/overview/uploadProfileAvatar', () => ({
 uploadProfileAvatar: vi.fn(),
}));

vi.mock('@/features/profile/overview/profileDetailQuery', () => ({
