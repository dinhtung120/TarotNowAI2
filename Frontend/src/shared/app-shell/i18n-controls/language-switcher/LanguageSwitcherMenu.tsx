import type { LocaleId } from '@/shared/app-shell/i18n-controls/language-switcher/localeConfig';
import { LOCALE_OPTIONS } from '@/shared/app-shell/i18n-controls/language-switcher/localeConfig';
import LanguageSwitcherOption from '@/shared/app-shell/i18n-controls/language-switcher/LanguageSwitcherOption';
