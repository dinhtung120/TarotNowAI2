...
export default function ActionConfirmModal({
 ...
 return (
  <div className={cn("fixed inset-0 z-[150] flex items-center justify-center p-6 animate-in fade-in duration-300")}>
   <div className={cn("absolute inset-0 tn-overlay-strong")} onClick={onCancel} />
   <div className={cn("relative z-10 w-full max-w-sm tn-panel rounded-[2.5rem] p-10 shadow-2xl animate-in zoom-in-95 duration-300")}>
    ...
    <p className={cn("text-xs text-[var(--text-secondary)] font-medium text-center leading-relaxed mb-8")}>{description}</p>
