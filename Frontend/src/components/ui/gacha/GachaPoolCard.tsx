...
import { localizeGachaDescription, localizeGachaName } from '@/components/ui/gacha/gachaLocalization';
import type { GachaPoolSelectorLabels } from '@/components/ui/gacha/GachaPoolSelector';
