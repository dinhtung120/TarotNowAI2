...
export default function HistoryDetailPage() {
    ...
    return (
        <UserLayout>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <div className="flex flex-col gap-6">
                        <button
                            ...
                            className="group flex items-center gap-2 text-[var(--text-secondary)] hover:text-white transition-all w-fit"
                        >
                            <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-[var(--purple-accent)] group-hover:text-black transition-all">
                        ...
                        <div className="flex items-center gap-6">
                            <div className="w-16 h-16 bg-[var(--bg-glass)] border border-white/10 rounded-[1.5rem] flex items-center justify-center shadow-2xl backdrop-blur-md">
                        ...
                        <div className="space-y-24 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                                ...
                                {parsedCards.map((cardId, index) => {
                                    ...
                                    return (
                                        <div key={index} className="group flex flex-col items-center gap-6">
                                            ...
                                            <div className="relative aspect-[2/3.2] w-full bg-[var(--bg-glass)] backdrop-blur-3xl rounded-[2.5rem] border border-white/10 p-5 cursor-default transition-all duration-700 hover:border-[var(--warning)] hover:shadow-[0_20px_80px_rgba(251,191,36,0.1)] hover:-translate-y-2">
                                                {/* Card Background Pattern */}
                                                <div className="absolute inset-4 border border-[var(--warning)]/10 rounded-[1.8rem] pointer-events-none" />
                                                
                                                <div className="h-full flex flex-col relative z-10">
                                                    {/* Card Art Area */}
                                                    <div className="flex-1 rounded-2xl bg-[#0a0a0a] overflow-hidden relative shadow-inner group-hover/art transition-all duration-700 mb-4 border border-white/5">
                                                        ...
                                                        <div className="absolute bottom-4 left-0 right-0 z-20 px-3 text-center">
                                                            ...
                                                            <h3 className="text-xs sm:text-sm font-black text-white italic tracking-tighter leading-tight drop-shadow-lg">
                                                                {cardData.name}
                                                            </h3>
                                                        </div>
                                                    </div>
                                                    ...
                                                    {/* Index Ribbon */}
                                                    <div className="absolute top-0 right-8 w-6 h-10 bg-[var(--warning)]/20 backdrop-blur-md rounded-b-lg flex items-center justify-center border border-t-0 border-[var(--warning)]/30">
                            ...
                            {detail.isCompleted && (
                                <div className="mt-32 max-w-4xl mx-auto">
                                    <div className="flex flex-col items-center gap-8 text-center bg-[var(--bg-glass)] backdrop-blur-3xl border border-white/5 p-12 sm:p-16 rounded-[4rem] relative overflow-hidden group">
                                        ...
                                        <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-full flex items-center justify-center animate-bounce-slow relative z-10 shadow-xl">
            ...
            {/* Custom Animations local to this page if needed */}
