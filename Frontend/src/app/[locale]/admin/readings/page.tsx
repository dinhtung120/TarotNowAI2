    ...
    return (
        <div className="space-y-8 pb-20 animate-in fade-in duration-700">
            ...
            <form 
                ...
                className="p-6 rounded-[2.5rem] bg-[var(--purple-accent)]/5 border border-white/5 backdrop-blur-3xl shadow-inner flex flex-wrap items-end gap-6"
            >
                <div className="flex-1 min-w-[240px] space-y-3 text-left">
                    ...
                    <div className="relative">
                        <input 
                            ...
                            className="w-full bg-white/[0.02] border border-white/10 rounded-2xl px-5 py-4 text-xs font-black text-white focus:outline-none focus:border-[var(--purple-accent)]/50 transition-all placeholder:text-[var(--text-tertiary)] shadow-inner"
                        />
                    </div>
                </div>
                ...
                <div className="w-56 space-y-3 text-left">
                    ...
                    <select 
                        ...
                        className="w-full bg-white/[0.02] border border-white/10 rounded-2xl px-5 py-4 text-xs font-black text-white focus:outline-none focus:border-[var(--purple-accent)]/50 transition-all appearance-none cursor-pointer shadow-inner"
                    >
                        <option value="" className="bg-[#0f0f0f]">Tất cả loại bài</option>
                        <option value="daily_1" className="bg-[#0f0f0f]">Daily 1 Card</option>
                        <option value="spread_3" className="bg-[#0f0f0f]">Spread 3 Cards</option>
                        <option value="spread_5" className="bg-[#0f0f0f]">Spread 5 Cards</option>
                        <option value="spread_10" className="bg-[#0f0f0f]">Spread 10 Cards</option>
                    </select>
                </div>
                ...
                <div className="w-44 space-y-3 text-left">
                    ...
                    <input 
                        ...
                        className="w-full bg-white/[0.02] border border-white/10 rounded-2xl px-5 py-4 text-xs font-black text-white focus:outline-none focus:border-[var(--purple-accent)]/50 transition-all shadow-inner [color-scheme:dark]"
                    />
                </div>
                                    ...
                                    <tr key={r.id} className="group/row hover:bg-white/[0.02] transition-colors">
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-[1rem] bg-black/40 border border-white/10 flex items-center justify-center shadow-inner group-hover/row:scale-110 transition-transform">
                                                    <User className="w-4 h-4 text-[var(--text-secondary)]" />
                                                </div>
                                                <div>
                                                    <div className="text-[11px] font-black text-white uppercase tracking-tighter drop-shadow-sm">{r.username || "Chưa định danh"}</div>
                                        ...
                                        <td className="px-8 py-6">
                                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/5 text-[10px] font-black text-white uppercase tracking-widest italic text-left shadow-inner">
                    ...
                    <div className="px-8 py-6 bg-white/[0.01] flex flex-col md:flex-row md:items-center justify-between gap-4 border-t border-white/5">
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="p-3.5 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 disabled:opacity-30 disabled:cursor-not-allowed transition-all shadow-inner"
                            >
                                <ChevronLeft className="w-4 h-4 text-[var(--text-secondary)]" />
                            </button>
                            <span className="text-xs font-black text-white italic mx-4 drop-shadow-sm">{page}</span>
                            <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <GlassCard className="!p-8 group flex flex-col justify-between min-h-[160px] text-left hover:border-[var(--purple-accent)]/30 transition-all">
                        ...
                        <div className="flex items-end justify-between">
                            <div className="text-4xl font-black text-white italic tracking-tighter drop-shadow-md">{data?.totalCount ?? 0}</div>
                    ...
                    <GlassCard className="!p-8 flex items-center gap-6 group hover:border-[var(--success)]/30 transition-all text-left">
                        ...
                        <div>
                            ...
                            <div className="text-sm font-black text-white uppercase italic tracking-tighter drop-shadow-md mt-1">Thời gian thực</div>
                        </div>
                    </GlassCard>
                    ...
                    <GlassCard className="!p-8 flex items-center justify-between group overflow-hidden relative text-left hover:border-[var(--accent)]/30 transition-all">
                        <div className="relative z-10 text-left">
                            ...
                            <div className="text-sm font-black text-white uppercase italic tracking-tighter drop-shadow-md mt-1">Sổ lệnh Admin</div>
                        </div>
