        ...
        <div className="space-y-8 pb-20 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <Button
                    ...
                    className={`shrink-0 ${!isCreating && 'bg-[var(--warning)] text-black hover:bg-[var(--warning)] hover:brightness-110 shadow-[0_0_20px_rgba(245,158,11,0.2)]'}`}
                >
                    ...
                    <GlassCard className="relative overflow-hidden group hover:border-[var(--warning)]/30 transition-all !p-8">
                        ...
                        <form onSubmit={handleCreate} className="relative z-10 space-y-8">
                            <div className="flex items-center gap-3 border-b border-white/5 pb-4">
                                ...
                                <h2 className="text-sm font-black text-white uppercase tracking-widest drop-shadow-sm">Khởi tạo Mốc thưởng mới</h2>
                            </div>
                                ...
                                <div className="space-y-3 text-left">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            placeholder="200,000"
                                            className="w-full bg-white/[0.02] border border-white/10 rounded-2xl pl-12 pr-4 py-4 text-xs font-black text-white focus:outline-none focus:border-[var(--warning)]/50 transition-all placeholder:text-[var(--text-tertiary)] shadow-inner"
                                        />
                            ...
                            <div className="flex flex-col sm:flex-row justify-end items-center gap-4 pt-2 border-t border-white/5">
                                ...
                                <Button 
                                    type="submit" 
                                    disabled={submitting}
                                    className="w-full sm:w-auto px-8 py-4 bg-[var(--warning)] text-black hover:bg-[var(--warning)] hover:brightness-110 shadow-[0_0_20px_rgba(245,158,11,0.2)]"
                                >
                                    ...
                                    <tr key={p.id} className="group/row hover:bg-white/[0.02] transition-colors">
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-xl bg-black/40 border border-white/10 flex items-center justify-center shadow-inner group-hover/row:scale-110 transition-transform">
                                                    <span className="text-[12px] font-black text-[var(--text-secondary)]">₫</span>
                                                </div>
                                                <div className="text-[11px] font-black text-white uppercase tracking-tighter drop-shadow-sm">
                                            ...
                                            <button
                                                ...
                                                className={`
                                                    ...
                                                    ${p.isActive 
                                                        ...
                                                        : "bg-white/[0.02] border-white/10 text-[var(--text-secondary)] hover:bg-white/5 hover:text-white"
                                                    }
                                                `}
                                            >
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <button
                                                ...
                                                className="p-3 rounded-xl text-[var(--text-secondary)] bg-white/[0.02] border border-white/5 hover:text-white hover:bg-[var(--danger)] hover:border-transparent transition-all shadow-sm group"
                                            >
            ...
            {deleteId && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-[#0F0F0F] border border-white/10 rounded-[2.5rem] p-10 shadow-2xl max-w-sm w-full transform transition-all animate-in fade-in zoom-in duration-300">
                        <div className="text-center space-y-6">
                            ...
                            <div className="space-y-4 text-left">
                                <h3 className="text-xl font-black text-white uppercase italic tracking-tighter text-center mb-2">Xóa Khuyến mãi?</h3>
                        ...
                        <div className="flex gap-4 mt-8">
                            ...
                            <Button
                                ...
                                className="flex-1 shadow-[0_0_20px_rgba(244,63,94,0.3)] hover:shadow-[0_0_30px_rgba(244,63,94,0.5)]"
                            >
                                Xóa bỏ
                            </Button>
                        </div>
