...
export default function WithdrawPage() {
 ...
 <span className="tn-text-primary font-bold">{grossVnd.toLocaleString('vi-VN')} ₫</span>
 </div>
 <div className="flex justify-between items-center text-sm">
 ...
 className={`w-full h-14 ${amountNum >= 50 ? '!bg-[var(--success)] !tn-text-primary hover:scale-[1.02]' : ''}`}
 >
 {submitting ? (
 <>
 ...
 <Clock className="w-4 h-4 text-[var(--text-secondary)]" /> Lịch sử rút tiền
 </h2>
 ...
 return (
 <div key={item.id} className="p-6 space-y-4 hover:tn-surface transition-colors">
 ...
 <span className="px-2.5 py-1 rounded-full text-[8px] font-black uppercase tracking-widest border tn-border-soft"
