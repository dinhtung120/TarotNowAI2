    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-4xl">
            ...
            <div className="bg-[#1A1F2B]/80 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-[#2D3748] text-gray-300 leading-relaxed font-sans space-y-6">
                <section>
                    <h2 className="text-2xl font-bold text-[#DFF2CB] mb-4">1. Thu thập thông tin</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-[#DFF2CB] mb-4">2. Sử dụng dữ liệu</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-[#DFF2CB] mb-4">3. Bảo vệ dữ liệu</h2>
                    <p>
