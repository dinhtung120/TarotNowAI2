...
export default function TermsOfServicePage() {
 ...
 <section>
 <h2 className="text-2xl font-bold tn-text-primary mb-4">1. Điều khoản chung</h2>
 <p>
 ...
 <section>
 <h2 className="text-2xl font-bold tn-text-primary mb-4">2. Miễn trừ trách nhiệm AI</h2>
 <p>
 ...
 <section>
 <h2 className="text-2xl font-bold tn-text-primary mb-4">3. Tài khoản và thanh toán</h2>
 <p>
