...
export default function RegisterPage() {
 ...
 <h2 className="text-3xl font-black italic tracking-tighter tn-text-primary mb-4 uppercase">Check Your Inbox</h2>
 ...
 return (
 <AuthLayout title="Join the Mystic" subtitle="Create an account to begin your journey"
 >
 {errorMsg && (
 ...
 placeholder="seeker@tarotnow.com" error={errors.email?.message} {...register('email')} />
 <Input label="Username" type="text" leftIcon={<AtSign className="w-4 h-4" />}
 placeholder="mystic_seeker" error={errors.username?.message} {...register('username')} />
 </div>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <Input label="Display Name" type="text" leftIcon={<User className="w-4 h-4" />}
 placeholder="Mystic Seeker" error={errors.displayName?.message} {...register('displayName')} />
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <Input label="Password" type="password" leftIcon={<Lock className="w-4 h-4" />}
 placeholder="••••••••" error={errors.password?.message} {...register('password')} />
 <Input label="Confirm Password" type="password" leftIcon={<Lock className="w-4 h-4" />}
 placeholder="••••••••" error={errors.confirmPassword?.message} {...register('confirmPassword')} />
 </div>

 <div className="pt-2">
 <label className="flex items-start gap-4 cursor-pointer group p-3 rounded-xl hover:tn-surface border border-transparent hover:tn-border-soft transition-all">
 ...
 <span className="text-sm font-medium tn-text-secondary group-hover:tn-text-secondary transition-colors leading-relaxed">
 ...
 Already a seeker?{' '}
 <Link href="/login" className="text-[var(--purple-accent)] font-bold hover:tn-text-primary transition-colors">
 Return to realm
 </Link>
 </p>
 </AuthLayout>
