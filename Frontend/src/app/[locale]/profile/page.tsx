                        ...
                        <GlassCard className="!p-8 overflow-hidden relative group">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8">
                                ...
                                <div className="relative w-28 h-28 shrink-0">
                                    ...
                                    <div className="w-full h-full rounded-full border-2 border-white/10 overflow-hidden relative z-10 shadow-2xl bg-[#020108]">
                                        <img
                                    ...
                                    <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-[#020108] border border-white/10 rounded-xl flex items-center justify-center text-[var(--warning)] shadow-xl z-20">
                                ...
                                <div className="flex-1 text-center md:text-left space-y-5">
                                    ...
                                    <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.08] transition-all duration-300">
                                            <div className="w-2 h-2 rounded-full bg-[var(--purple-accent)] shadow-[0_0_8px_rgba(168,85,247,0.6)]" />
                                            <span className="text-[10px] font-black uppercase tracking-widest text-[var(--text-tertiary)]">{t("level")}</span>
                                            <span className="text-xs font-black text-white ml-0.5">{profileData.level}</span>
                                        </div>
                                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.08] transition-all duration-300">
                                            <div className="w-2 h-2 rounded-full bg-[var(--info)] shadow-[0_0_8px_rgba(59,130,246,0.6)]" />
                                            <span className="text-[10px] font-black uppercase tracking-widest text-[var(--text-tertiary)]">{t("zodiac")}</span>
                                            <span className="text-xs font-black text-white ml-0.5">{profileData.zodiac}</span>
                                        </div>
                                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.08] transition-all duration-300">
                                            <div className="w-2 h-2 rounded-full bg-[var(--warning)] shadow-[0_0_8px_rgba(245,158,11,0.6)]" />
                                            <span className="text-[10px] font-black uppercase tracking-widest text-[var(--text-tertiary)]">{t("numerology")}</span>
                                            <span className="text-xs font-black text-white ml-0.5">{profileData.numerology}</span>
                                        </div>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white/[0.02] border border-white/10 rounded-xl px-4 py-3.5 text-sm text-white font-medium focus:outline-none focus:border-[var(--purple-accent)]/50 focus:ring-1 focus:ring-[var(--purple-accent)]/20 transition-all shadow-inner"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white/[0.02] border border-white/10 rounded-xl px-4 py-3.5 text-sm text-white font-medium focus:outline-none focus:border-[var(--purple-accent)]/50 focus:ring-1 focus:ring-[var(--purple-accent)]/20 transition-all shadow-inner [color-scheme:dark]"
                                    />
