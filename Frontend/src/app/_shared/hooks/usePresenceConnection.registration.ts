...
import { applyWalletDelta, createPresenceWalletRefreshScheduler } from '@/app/_shared/hooks/usePresenceConnection.registration.wallet';
import { createPresenceInvalidationScheduler } from '@/app/_shared/hooks/usePresenceConnection.registration.invalidationScheduler';
import { createPresenceRoleChangeLogoutCoordinator } from '@/app/_shared/hooks/usePresenceConnection.registration.roleLogout';
...
import { registerPresenceDomainEventHandlers } from '@/app/_shared/hooks/usePresenceConnection.registration.domainEvents';
import { startPresenceHeartbeat } from '@/app/_shared/hooks/usePresenceConnection.registration.heartbeat';
import { createPresenceStatusObserverCoordinator } from '@/app/_shared/hooks/usePresenceConnection.registration.statusObservers';
