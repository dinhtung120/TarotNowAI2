...
- Review concern cross-cutting: JWT ngắn hạn, refresh rotation, policy authorization, rate limit, cookie an toàn.
...
- Evidence gốc cần đối chiếu: `ApiAndConfigurationStandardsTests.cs`.
